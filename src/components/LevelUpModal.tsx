  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      confetti({
        ...
        spread: 70,
        origin: { y: 0.55 },
        colors: ['#00e599', '#3b82f6', '#f59e0b', '#ec4899'],
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 w-48 h-32 bg-emerald-500/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col items-center space-y-4 pt-2 relative z-10">
          <motion.div
            ...
            className="relative"
          >
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-tr from-amber-500 via-emerald-400 to-cyan-400 p-0.5 shadow-xl shadow-amber-500/25">
              <div className="w-full h-full bg-[#0a0a0d] rounded-[22px] flex items-center justify-center text-amber-400 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-tr from-amber-500/10 to-transparent" />
                <Trophy className="w-9 h-9 stroke-[1.75]" />
              </div>
            </div>
            <div className="absolute -bottom-1.5 -right-1.5 bg-amber-500 text-black rounded-full p-1 border-2 border-black shadow-md">
              <Sparkles className="w-3.5 h-3.5 fill-black" />
            </div>
          </motion.div>

          <div className="space-y-1.5">
            <span className="text-[10px] font-mono font-extrabold tracking-[0.2em] text-amber-400 uppercase bg-amber-500/10 px-3.5 py-1 rounded-full border border-amber-500/25 inline-flex items-center gap-1.5 shadow-inner">
        ...
        <motion.button
          ...
          onClick={onClose}
          className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-amber-400 via-emerald-400 to-[#00e599] hover:brightness-110 text-black font-extrabold text-xs tracking-wider uppercase transition-all shadow-lg shadow-amber-500/20 active:scale-98 flex items-center justify-center gap-2 relative z-10"
        >
